...
class VendorImagesRepository:
    ...
    async def get_images_for_event_vendor(self, event_vendor_id: uuid.UUID) -> List[VendorImagesReadSchema]:
        ...
        return [VendorImagesReadSchema(event_vendor_id=image.event_vendor_id, image_data=base64.b64encode(image.image_data), created_at=image.created_at) for image in images]  # type: ignore